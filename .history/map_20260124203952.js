 ...
 * All positions are in 3D coordinates (x, y, z)
...
const VENUE_CONFIG = {
    ...
    // Define your venue structures here
    structures: [
        // Main Stage
        {
            type: 'building',
            position: { x: -15, z: -15 },
            size: { width: 60, height: 8, depth: 100 },
            color: 0xe74c3c,
            name: 'Main Stage',
            description: 'Live performances & keynotes'
        },

        // Exhibition Booths - Using array generation for repeated structures
        ...generateGrid({
            type: 'building',
